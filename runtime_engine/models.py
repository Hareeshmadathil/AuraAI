...
class RuntimeEventType(StrEnum):
    ...
    WEB_RESEARCH_PLAN_CREATED = "web_research_plan_created"
    WEB_RESEARCH_PLAN_APPROVED = "web_research_plan_approved"
    WEB_RESEARCH_PLAN_REJECTED = "web_research_plan_rejected"
    WEB_CRAWL_STARTED = "web_crawl_started"
    WEB_PAGE_ALLOWED = "web_page_allowed"
    WEB_PAGE_BLOCKED = "web_page_blocked"
    ROBOTS_CHECKED = "robots_checked"
    WEB_EVIDENCE_EXTRACTED = "web_evidence_extracted"
    ...
    BROWSER_SESSION_STOPPED = "browser_session_stopped"
    WEB_RESEARCH_COMPLETED = "web_research_completed"
    WEB_RESEARCH_FAILED = "web_research_failed"
    INTELLIGENCE_RUN_STARTED = "intelligence_run_started"
    INTELLIGENCE_SIGNAL_RECEIVED = "intelligence_signal_received"
    INTELLIGENCE_SIGNAL_REJECTED = "intelligence_signal_rejected"
    SOURCE_AUTHORITY_SCORED = "source_authority_scored"
    EVIDENCE_WEIGHTED = "evidence_weighted"
    CONTRADICTION_DETECTED = "contradiction_detected"
    FRESHNESS_ASSESSED = "freshness_assessed"
    COMPETITOR_PRIORITY_SCORED = "competitor_priority_scored"
    RESEARCH_PRIORITY_SCORED = "research_priority_scored"
    RESEARCH_QUEUE_CREATED = "research_queue_created"
    RESEARCH_QUEUE_REVISED = "research_queue_revised"
    WEB_PLAN_REQUEST_CREATED = "web_plan_request_created"
    FOUNDER_INTELLIGENCE_REVIEW_REQUIRED = "founder_intelligence_review_required"
    INTELLIGENCE_ITEM_APPROVED = "intelligence_item_approved"
    INTELLIGENCE_ITEM_HELD = "intelligence_item_held"
    INTELLIGENCE_ITEM_REJECTED = "intelligence_item_rejected"
    INTELLIGENCE_RUN_COMPLETED = "intelligence_run_completed"
    INTELLIGENCE_RUN_FAILED = "intelligence_run_failed"
    KNOWLEDGE_RUN_STARTED = "knowledge_run_started"
    KNOWLEDGE_INGESTION_REQUESTED = "knowledge_ingestion_requested"
    KNOWLEDGE_INGESTION_REJECTED = "knowledge_ingestion_rejected"
    KNOWLEDGE_ITEM_CREATED = "knowledge_item_created"
    KNOWLEDGE_VERSION_CREATED = "knowledge_version_created"
    KNOWLEDGE_DUPLICATE_DETECTED = "knowledge_duplicate_detected"
    KNOWLEDGE_CONFLICT_DETECTED = "knowledge_conflict_detected"
    KNOWLEDGE_FRESHNESS_CHANGED = "knowledge_freshness_changed"
    KNOWLEDGE_REFRESH_REQUIRED = "knowledge_refresh_required"
    KNOWLEDGE_RETENTION_DECIDED = "knowledge_retention_decided"
    KNOWLEDGE_FOUNDER_REVIEW_REQUIRED = "knowledge_founder_review_required"
    KNOWLEDGE_ITEM_APPROVED = "knowledge_item_approved"
    KNOWLEDGE_ITEM_REJECTED = "knowledge_item_rejected"
    KNOWLEDGE_ITEM_SUPERSEDED = "knowledge_item_superseded"
    KNOWLEDGE_ITEM_ARCHIVED = "knowledge_item_archived"
    KNOWLEDGE_QUERY_EXECUTED = "knowledge_query_executed"
    KNOWLEDGE_CONTEXT_CREATED = "knowledge_context_created"
    KNOWLEDGE_RUN_COMPLETED = "knowledge_run_completed"
    KNOWLEDGE_RUN_FAILED = "knowledge_run_failed"
