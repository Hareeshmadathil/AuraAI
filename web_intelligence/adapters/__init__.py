...
from web_intelligence.adapters.crawl4ai_adapter import create_crawl4ai_adapter
...
__all__=["HttpPublicAdapter","UnavailableAdapter","WebAdapter","create_browser_use_adapter","create_crawl4ai_adapter"]
